...
import { CalculatorIcon, FlaskConical, History, Scale } from "lucide-react"
  ...
  return (
    <Tabs defaultValue="calculator" className="w-full">
      ...
      <TabsContent value="feeding-rate" className="mt-6">
        <div className="space-y-4">
          <div className="text-center">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Weight-Based Feeding Rate Calculator</h2>
            <p className="text-gray-600 dark:text-gray-300">
