...
export default function AnalyticsPage() {
  ...
  const fetchAnalytics = async () => {
    setLoading(true)
    try {
      const data = await logger.getCalculationStats(days)
      setAnalytics(data)
    } catch (error) {
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                When signed in, your usage data is saved to the cloud and synced across devices.
                When not signed in, data is stored locally in your browser.
              </p>
            </CardContent>
          </Card>
        </div>
